...
use midimon_daemon::daemon::error::IpcErrorCode;
use midimon_daemon::daemon::types::{IpcRequest, ResponseStatus};
...
fn test_small_request_accepted() {
    ...
    let request = IpcRequest {
        ...
        command: midimon_daemon::daemon::types::IpcCommand::Ping,
...
fn test_large_valid_request_accepted() {
    ...
    let request = IpcRequest {
        ...
        command: midimon_daemon::daemon::types::IpcCommand::ValidateConfig,
        args: large_args,
    };
...
fn test_typical_request_sizes() {
    ...
    let status_request = IpcRequest {
        id: "test".to_string(),
        command: midimon_daemon::daemon::types::IpcCommand::Status,
        args: serde_json::json!({}),
    };

    let reload_request = IpcRequest {
        id: "test".to_string(),
        command: midimon_daemon::daemon::types::IpcCommand::Reload,
        args: serde_json::json!({}),
    };
...
fn test_security_error_details() {
    ...
    use midimon_daemon::daemon::types::{ErrorDetails, IpcResponse};
