...
//!
//! This diagnostic tool uses the test simulator module from midimon-daemon/tests/
//! No midimon_core imports needed - this is a standalone testing utility.
...
// Import the simulator from tests module (midimon-daemon/tests/midi_simulator.rs)
