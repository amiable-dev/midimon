...
fn sign_plugin(plugin_path: &str, key_path: &str, name: Option<&str>, email: Option<&str>) {
    ...
    #[cfg(feature = "plugin-signing")]
    {
        use midimon_core::plugin::signing::sign_plugin;
...
fn verify_plugin(plugin_path: &str) {
    ...
    #[cfg(feature = "plugin-signing")]
    {
        ...
        let sig_metadata: midimon_core::plugin::signing::SignatureMetadata =
...
fn trust_add(public_key: &str, name: &str) {
    ...
    #[cfg(feature = "plugin-signing")]
    {
        use midimon_core::plugin::signing::add_trusted_key;
...
fn trust_list() {
    ...
    #[cfg(feature = "plugin-signing")]
    {
        use midimon_core::plugin::signing::load_trusted_keys;
...
fn trust_remove(public_key: &str) {
    ...
    #[cfg(feature = "plugin-signing")]
    {
        use midimon_core::plugin::signing::{load_trusted_keys, save_trusted_keys};
