  ...
  <div class="settings-content">
        ...
        <label class="setting-label">
          ...
          <div class="setting-text">
            ...
            <div class="setting-description">
              Automatically launch MIDIMon when you log in to your computer
            </div>
          </div>
        </label>
      </div>
      ...
      <div class="setting-item">
        <label class="setting-label">
          ...
          <div class="setting-text">
            ...
            <div class="setting-description">
              Keep MIDIMon running in the background when window is closed
            </div>
          </div>
        </label>
      </div>
    ...
    <section class="settings-section">
      ...
      <div class="about-content">
        <div class="app-info">
          <div class="app-name">MIDIMon GUI</div>
          <div class="app-version">Version 2.0.0</div>
          <div class="app-description">
            Visual configuration interface for MIDIMon daemon
          </div>
        </div>

        <div class="links">
          <a href="https://github.com/amiable/midimon" target="_blank" rel="noopener noreferrer">
            GitHub Repository
          </a>
          <a href="https://github.com/amiable/midimon/issues" target="_blank" rel="noopener noreferrer">
            Report an Issue
          </a>
          <a href="https://github.com/amiable/midimon/wiki" target="_blank" rel="noopener noreferrer">
            Documentation
          </a>
        </div>
